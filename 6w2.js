/*
IOS/安卓： 快手极速版稳定明文防黑版
0509版本更新，JS脚本透明，用的放心。无需代理，可直接开跑。

###青龙面板左边第三个 配置文件 按钮内增加以下内容

#00快手极速新版CK格式如下：（一行一个，回车换行）
export ksjsbCookie='kuaishou.api_st=Cg9rdWFpc2xTBC-lFzKTlEm0JDGX.......................tvKAUwAQ; 
kuaishou.api_st=Cg9rdWFpc2hvdS5.......................tvKAUwAQ; 
kuaishou.api_st=Cg9rdWFpc2hvdS5.......................tvKAUwAQ;'

#提现金额变量 ksjsbCash；数值3,10,2050;  变量 ksjsbWithdrawTime，提现时间默认15 。
export ksjsbWithdrawTime='15'
export ksjsbCash='10'
最大化提现变量 ksjsbAggressive不建议开启。
#export ksjsbAggressive=1

###以下定时二选一：
1、cron全天定时：27 3-23/2 * * *
2、cron分阶段定时：0 27 3,4,5,6,7,8,14,15,16,17,18,19 * * ? 
五组广告数据混合，提升收益的同时还降低黑号风险。
预计日收益6w金币。
...
let _0x134a17 = new Date(),
    ...
    _0x2e716e = 0,
    _0x5bc515 = "ksjsb",
    _0x180c0c = "http://0546cq.com:2031/ks.json",//json
    ksjsbjk = "http://0546cq.com:2031/ksjsb-ziye.json",//json
