...
let _0x134a17 = new Date(),
    ...
    _0x2e716e = 0,
    _0x5bc515 = "ksjsb",
    _0x180c0c = "http://127.0.0.1:5700/ks.json",
    ksjsbjk = "http://127.0.0.1:5700/Aksjsb.json",
...
class _0x9d8dda {
  ...
  async ["ksNeoAdParam"](T) {
    ...
    //修改后
    if (_0x1a0963 && _0x1a0963["length"] ) {
        C = _0x1a0963[Math["floor"](Math["random"]() * _0x1a0963["length"] - 1)];
    }
  ...
  if (p[_0x5bc515]) {
    ...
    if (a["status"] == 0) {
      if (_0x459e63 >= a["version"]) {
        _0x2e716e = true;
        _0x75eec0 = "https://127.0.0.1:5700/ks.json";
...
function Envcc(T, c) {
  const p = {
    ...
    'dceom': 'ijzfe',
    'JighY': 'updateMsg',
    'uwDzR': "https://127.0.0.1:5700/ks.json",
    'CvmUM': function (S, a) {
      return S === a;
    },
    'QfLFC': "JwVvM",
    ...
    [p["QrmhW"]](S, a) {
      if (p["JpIGP"]('ViWHE', p["NOwog"])) {
        if (p["QwtqA"](q, i[p["LTEld"]])) {
          d = true;
          u = "https://127.0.0.1:5700/ks.json";
